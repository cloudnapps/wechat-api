 ...
 * Examples:
 * ```
 * api.setPayCell('cardId', true, callback);
 * ```
 * Callback:
 *
 * - `err`, 调用失败时得到的异常
 ...
 * @name setPayCell
 * @param {String} cardId 卡券ID
 * @param {Boolean} isOpen 是否开启买单功能
 * @param {Function} callback 回调函数
 */
make(exports, 'setPayCell', function (cardId, isOpen, callback) {
  var url = 'https://api.weixin.qq.com/card/paycell/set?access_token=' + this.token.accessToken;
  var data = {
    "card_id": cardId,
    "is_open": isOpen
  };
 ...
 * Examples:
 * ```
 * api.setSelfConsumeCell('cardId', true, callback);
 * ```
 * Callback:
 *
 * - `err`, 调用失败时得到的异常
 ...
 * ```
 *
 * @name setSelfConsumeCell
 * @param {String} cardId 卡券ID
 * @param {Boolean} isOpen 是否开启买单功能
 * @param {Function} callback 回调函数
 */
make(exports, 'setSelfConsumeCell', function (cardId, isOpen, callback) {
  var url = 'https://api.weixin.qq.com/card/selfconsumecell/set?access_token=' + this.token.accessToken;
  var data = {
    "card_id": cardId,
    "is_open": isOpen
  };
